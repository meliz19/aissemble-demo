...
Originally generated from: templates/inference/inference.api.driver.py.vm
"""
...
from aissemble_machine_learning_inference.generated.inference.grpc.inference_api_grpc_base import (
    InferenceGrpcBase,
)
from aissemble_machine_learning_inference.generated.inference.grpc import (
    inference_api_pb2_grpc,
)
...
async def launch_fast_api_server():
    fast_api_interface = (
        "aissemble_machine_learning_inference.inference.rest.inference_api_rest:app"
    )
    logging.info("Uvicorn/fastAPI server starting and listening on port 8000...")

    config = uvicorn.Config(
        fast_api_interface, host="0.0.0.0", port=8000, log_level="info"
    )
